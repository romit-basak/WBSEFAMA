...
include 'config.php';
$profiles = $conn->query(" SELECT * FROM Committees a, profiles b WHERE a.MemNo = b.MemNo AND CommitteeCode='BF' ORDER BY SortOrder ");
...
<main>
<h1>Members' Benevolence Scheme Committe</h1>
